...
export const ACTION_LINKS = {
  analysis: [
    ...
    { id: 'archive', label: 'Wayback', icon: 'archive.png', url: d => `https://web.archive.org/web/*/${d}` },
    { id: 'namebio', label: 'Namebio', icon: 'namebio.png', url: d => `https://namebio.com/?term=${d.split('.')[0]}` },
